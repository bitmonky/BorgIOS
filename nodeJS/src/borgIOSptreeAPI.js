// borgIOSptreeAPI.js – CLEANED VERSION
...
class BorgIOSptreeAPI {
  ...
  async ptreeDeleteShard(muid, hash, hashID, encrypted = null, nCopys = 3) {
    return this._postJSON("shardTreeCell", {
      msg: { req: "deleteShard", shard: { ownerID: muid, pubKey: this.net.publicKey,hash, hashID, nCopys } }
    });
  }
      ...
      const body = {
        msg: {
          ...
          shard: {
            ...
            delAuth : this.net.signToken(shard.shardHID)
          }
        }
      };
...
module.exports.BorgIOSptreeAPI = BorgIOSptreeAPI;
